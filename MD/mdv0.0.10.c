...
/* Este es un primer intento de reescaleo, pero a veces no funciona.
Las fluctuaciones generan que el programa salga del while antes 
de haber llegado a reescalar las velocidades.*/    
    while(*Tr>Td)
     {
      i++;
