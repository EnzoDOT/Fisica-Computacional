...
{ 
  int i,N,sfreq,sfreq2,tsteps,icount,icount2,icount3,icount4,jit;
...
//    Td=T;
    ...
    for(i=0;i<tsteps;i++)
      ...
      *Tr=calc_T(v,N);    
      ...
      if(*Tr>Td && i%sfreq==0 && jit==0){
      escaleo_v(v,N,Tr,Td);   
      printf("Escaleando velocidades... \n");
      }

      if(abs(*Tr-Td)<=0.1 && jit==0){
       jit=1;
       printf("Temperatura deseada alcanzada en %d pasos. \n",i);
       printf("Tr= %lf \n",*Tr);       
       }  
